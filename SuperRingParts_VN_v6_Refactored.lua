--[[
    Super Ring Parts V6 Refactored - Scrollable UI + All Fixes
    Tác giả gốc: lukas (Robloxlukasgames)
    Nâng cấp: [ZERO2]
    • Scrollable container
    • Toggle menu (RightShift)
    • No lag, all bugs fixed
    • Grid layout auto
    • Smooth animations
]]
...
------------------------------------------------------------
-- 🎚️ CREATE CONTROL (Radius/Height/Speed/Strength)
------------------------------------------------------------
...
MinimizeButton.MouseButton1Click:Connect(function()
    ...
    local target = UIState.minimized and UDim2.new(0, 360, 0, 46) or UDim2.new(0, 360, 0, 560)
...
------------------------------------------------------------
-- 🌪️ TORNADO / RING PARTS LOGIC (100% original)
------------------------------------------------------------
...
print("✓ SuperRingParts V6 loaded! Press RightShift to toggle menu.")
